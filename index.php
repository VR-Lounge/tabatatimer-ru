...
<option value="https://radiorecord.hostingradio.ru/201096.aacp">2010 – Танец 10-х</option>
    ...
    <div id="quoteAuthor" style="text-align: right; margin-top: 5px; margin-bottom: 20px; font-size: 16px; color: white;">
        <!-- Имя автора будет здесь -->
				...
				<a id="timerEndFitnessZozh" class="button shine" href="https://www.tabatatimer.ru/blog.html?utm_source=tabatatimer&amp;utm_medium=timer&amp;utm_campaign=workout_finish&amp;utm_content=fitness_zozh" target="_blank" rel="noopener noreferrer" style="width:100%; box-sizing:border-box; display:block; text-align:center; text-decoration:none; margin-top:1.5rem;">ФИТНЕС И ЗОЖ</a>
				...
				<p class="timer-end-blog-caption" style="text-align:center; margin:0.65rem 0 0 0; font-size:0.82rem; line-height:1.35; letter-spacing:0.02em; color:rgba(255,255,255,0.78);">Проект живёт много лет и всегда будет бесплатным: таймеры и все материалы — без подписки и скрытых платежей. Автор поддерживает его за свой счёт. Но если хотите помочь дальнейшему развитию, можно перевести любую сумму добровольно — через СБП (сервис донатов OZON Банк), без комиссии с вашей стороны.</p>
