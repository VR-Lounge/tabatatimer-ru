...
<option value="https://radiorecord.hostingradio.ru/201096.aacp">2010 – Танец 10-х</option>
    ...
    <div id="quoteAuthor" style="text-align: right; margin-top: 5px; margin-bottom: 20px; font-size: 16px; color: white;">
        <!-- Имя автора будет здесь -->
				...
				<a id="timerEndFitnessZozh" class="button" href="https://www.tabatatimer.ru/blog.html?utm_source=tabatatimer&amp;utm_medium=timer&amp;utm_campaign=workout_finish&amp;utm_content=fitness_zozh" target="_blank" rel="noopener noreferrer" style="width:100%; margin-top:1.5rem; opacity:.9; box-sizing:border-box; display:block; text-align:center; text-decoration:none;">ФИТНЕС И ЗОЖ</a>
				<a id="moreTRXfromTimer" class="button shine" href="https://finance.ozon.ru/apps/sbp/ozonbankpay/019d6302-2ad5-7d68-9414-7264e6578bff" target="_blank" rel="noopener noreferrer" style="width:100%; box-sizing:border-box; display:block; text-align:center; text-decoration:none; margin-top:1.5rem;">Благодарность</a>
				<p class="timer-end-blog-caption" style="text-align:center; margin:0.65rem 0 0 0; font-size:0.82rem; line-height:1.35; letter-spacing:0.02em; color:rgba(255,255,255,0.78);">Проект живёт много лет и всегда будет бесплатным: таймеры и все материалы — без рекламы и скрытых платежей. Автор создаёт и поддерживает его за свой счёт. Если ТАБАТА ТАЙМЕР помог тебе стать лучше, можешь помочь его развитию любой суммой — через СБП (сервис донатов OZON Банк), без комиссии.</p>
...
jQuery(document).ready(function($) {
	...
	$('#timerEndFitnessZozh').on('click', function() {
